...
import VttHeader from '@/components/vtt/VttHeader';
import VttJournalDrawer from '@/components/vtt/VttJournalDrawer';
import VttQuickSheetDrawer from '@/components/vtt/VttQuickSheetDrawer';
  ...
  return (
    <div className="min-h-screen bg-[#070b19] text-slate-100 flex flex-col h-screen overflow-hidden">
      ...
      <VttHeader
        ...
        onOpenNpcDrawer={() => setIsNpcDrawerOpen(true)}
      ...
      <VttQuickSheetDrawer
        ...
        onClose={() => setSelectedCharacterSheet(null)}
        userRole={userRole}
        currentUser={currentUser}
        table={table}
        customConditions={customConditions}
        rollCooldownRemaining={rollCooldownRemaining}
        onRollQuickAction={handleRollFromQuickSheet}
        onToggleStatus={handleToggleStatus}
        onOpenManageStatus={() => setIsManagingStatus(true)}
